...
#pb2 = LINE("drwirot2@vmailcloud.com","wirot2532")
...
pb11 = LINE("drwirot11@vimail24.com","wirot2532")
#pb11 = LINE("EIMYtrDQ1GpeW3dyosIe.UmVBXItyD7iBb7/B5zME7G.zprbkLLXnb1ueJHsDW/iembfCRSOeimwf3xuCaUbD+E=")
#pb11.log("Auth Token : " + str(pb11.authToken))
...
pb11MID = pb11.getProfile().mid

mid = sb.getProfile().mid
PRANK = [pb1,pb2,pb3,pb4,pb5,pb6,pb7,pb8,pb9,pb10,pb11,sb]
Bots = [sbMID,pb1MID,pb2MID,pb3MID,pb4MID,pb5MID,pb6MID,pb7MID,pb8MID,pb9MID,pb10MID,pb11MID]
...
#CREATOR BY ACIL PRANKBOTS.
                            ...
                            pb11.acceptGroupInvitationByTicket(to,Ticket)
                            G = sb.getGroup(msg.to)
                            G.preventedJoinByTicket = True
                            random.choice(PRANK).updateGroup(G)
